...
public class DepartamentController {
	...
	@GetMapping
	public ResponseEntity<List<DepartamentBaseDTO>> getDepartaments(@RequestParam Optional<String> name) {
	...
	public ResponseEntity<DepartamentBaseDTO> updateDepartament(@PathVariable(value = "id") Long id, @RequestBody DepartamentBaseDTO departamentBaseDTO) {
