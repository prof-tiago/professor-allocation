...
public class ProfessorController {
	...
	@GetMapping
	public ResponseEntity<List<ProfessorBaseDTO>> getProfessors(@RequestParam Optional<String> name) {
		List<Professor> professors = professorService.findAll(name.orElse(null));
	...
	public ResponseEntity<ProfessorBaseDTO> updateProfessor(@PathVariable(value = "id") Long id, @RequestBody ProfessorBaseDTO professorBaseDTO) {
